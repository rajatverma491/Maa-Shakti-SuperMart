...
window.Modernizr = (function( window, document, undefined ) {
    ...
    isEventSupported = (function() {
      ...
      function isEventSupported( eventName, element ) {
        ...
        // When using `setAttribute`, IE skips "unload", WebKit skips "unload" and "reExpiryDate", whereas `in` "catches" those
    ...
    tests['backgroundExpiryDate'] = function() {
        return testPropsAll('backgroundExpiryDate');
    };
